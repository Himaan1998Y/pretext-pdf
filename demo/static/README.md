...
- `pretext-pdf` is loaded at runtime from [esm.sh](https://esm.sh/) (`https://esm.sh/pretext-pdf@0.8.1`). The 0.8.1 release fixed module-init crashes in browsers; older versions will not load via esm.sh.
