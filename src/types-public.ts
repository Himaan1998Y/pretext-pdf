/**
 * pretext-pdf — Public TypeScript types (stable npm exports)
 *
 * These types form the public API surface and are exported to npm consumers.
 * This file is never intended to grow beyond what is semantically "public schema".
