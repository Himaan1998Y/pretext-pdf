 ...
 * pre-release patch increment (e.g. `0.0.6-patched.1`, `0.0.6-patched.2`, …)
 * but NOT a different base version (`0.0.7-patched.0`) or a different label
 * (`0.0.6-rc.2`). Bump this string when re-vendoring.
 */
export const COMPATIBLE_RANGE = '0.0.6-patched.x'
