 ...
 */
export async function measureAllBlocks(doc, contentWidth, imageMap, pageContentHeight, plugins) {
    ...
    for (let i = 0; i < doc.content.length; i++) {
        ...
        if (el.type === 'image') {
            ...
            if (plugin) {
                ...
                const block = await runPluginMeasure(plugin, el, { contentWidth, contentHeight: pageContentHeight, doc }, hasAsset ? pluginImageKey : undefined);
                results.push(block);
            }
            else {
