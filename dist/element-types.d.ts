 ...
 * @public
 */
export declare const ELEMENT_TYPES: readonly ["paragraph", "heading", "spacer", "table", "image", "svg", "qr-code", "barcode", "chart", "list", "hr", "page-break", "code", "rich-paragraph", "blockquote", "toc", "toc-entry", "comment", "form-field", "callout", "footnote-def", "float-group"];
/**
